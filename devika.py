...
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": ["https://localhost:3000", "https://devika-frontend-devika.apps.ocp4.trader.decisioncrafters.com/"]}}) # Change the origin to your frontend URL
